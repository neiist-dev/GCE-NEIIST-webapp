...
describe('LatestId', () => {
    it('Should get latestId == 0', async () => {
        expect(await fileServices.getCurrentId('test')).to.equal(0);
    });
    ...
    it('Should get latestId == 1', async () => {
        ...
        expect(await fileServices.getCurrentId('test')).to.equal(1);
        try {
    ...
    it('Should get latestId == 2', async () => {
        ...
        expect(await fileServices.getCurrentId('test')).to.equal(2);
